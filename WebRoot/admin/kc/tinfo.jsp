...
<script  language="javascript" >
    function top2(){
        form3.action="<%=basePath%>admin/kc/tinfo.jsp?page=1";
        form3.submit();
    }
    function last2(){
        if(form3.pageCount.value==0){//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action="<%=basePath%>admin/kc/tinfo.jsp?page="+form3.pageCount.value;
            form3.submit();
        }
    }
    function pre2(){
        ...
        if(page<=1){
            ...
            form3.action="<%=basePath%>admin/kc/tinfo.jsp?page="+(page-1);
            form3.submit();
        }
    }
    ...
    function bjump2(){
        ...
        if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if(pageCount==0){
                ...
                form3.action="<%=basePath%>admin/kc/tinfo.jsp?page="+pageCount;
                form3.submit();
            }
        }
            ...
            if(page==0){
                ...
                form3.action="<%=basePath%>admin/kc/tinfo.jsp?page="+page;
                form3.submit();
            }else{
                form3.action="<%=basePath%>admin/kc/tinfo.jsp?page="+page;
                form3.submit();
    ...
    <div class="sort_style">
        <div class="sort_list">
            <div id="myDiv">
                ...
                int cou = cb.getMessageCount("select count(*) from rk where rkbh like '%"+rkbh+"%' and mc like '%"+mc+"%' and fl='"+fl+"' and sj>='"+ksj+"' and sj<='"+esj+"'");//得到信息总数
                ...
                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from rk where rkbh like '%"+rkbh+"%' " +
                 "and mc like '%"+mc+"%' and fl='"+fl+"' and sj>='"+ksj+"' and sj<='"+esj+"' order by id desc",15);
...
<% if(cou>0){ %>
<center>
    <form action="" method="post" name="form3"><button type="button" class="btn_search" onclick="method5('tableExcel')">导出Excel</button>
