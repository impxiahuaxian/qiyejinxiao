...
<div class="page-content clearfix">
    <div class="sort_style">
        <form name="sform" method="post" action="<%=basePath%>admin/fl/sinfo.jsp">
       ...
       <span class="l_f">
        <a href="<%=basePath%>admin/fl/add.jsp?method=addfl" class="btn btn-warning"><i class="fa fa-plus"></i> 添加</a>
        ...
        <div class="sort_list">
            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        <a title="编辑" href="<%=basePath%>admin/fl/add.jsp?method=upfl&id=<%=pagelist2.get(0).toString()%>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        <a title="删除" onclick="if (confirm('确定要删除吗？')) return true; else return false;" href="<%=basePath%>fl/del/<%=pagelist2.get(0).toString()%>" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                    </td>
                </tr>
                <%}}%>
                </tbody>
